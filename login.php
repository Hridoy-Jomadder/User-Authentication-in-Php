                    ...
                    <div class="col-12 col-md-9 col-lg-7 col-xl-6">
                        <div class="card my-5" style="border-radius: 15px;">
                            <div class="card-body p-5">
                                <h4 class=" text-center">User Authentication and Role Management System</h4>
                                ...
                                <form method="POST" action="<?php echo $_SERVER['PHP_SELF']; ?>">
                                    ...
                                    <div class="d-flex justify-content-center">
                                        <button type="submit" class="btn btn-success btn-block btn-lg gradient-custom-4 text-body" name="login" value="login">Login</button>

                                    </div>

                                    <p class="text-center text-muted mt-5 mb-0">Don't have an account? <a href="registration.php" class="fw-bold text-body"><u>Registration here</u></a></p>
